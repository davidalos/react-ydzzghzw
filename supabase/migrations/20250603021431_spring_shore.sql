/*
  ...
  1. Tables
    - user_profiles: Stores staff member profiles
    - clients: Stores client information
    - incidents: Records incidents reported by staff
    - goals: Tracks client goals
    - goal_updates: Tracks progress on goals

  2. Security
    - RLS enabled on all tables
    - Specific policies for data access control
    - Role-based access (employee vs manager)
*/

-- Create user_profiles table for staff members
